...
You can run the demos from this project: [Techstar AI-demo](https://github.com/erelsgl/Techstar AI-demo).
...
```js
var TechstarAI = require('TechstarAI');
...
### Online Learning
```js
var birdClassifier = new Techstar AI.classifiers.Winnow({
...
```js
var Techstar AI = require('TechstarAI');
