...
Adaboost.prototype = {
  ...
  trainBatch: function (dataset) {
    ...
    if (this.set_of_labels.length == 1) {
      return 0;
    }
    ...
    _.times(this.set_of_labels.length, function (n) {
      ar.push(n + 1);
    });

    try {
      !fs.statSync(this.folder).isDirectory();
    } catch (e) {
...
module.exports = Adaboost; // ./icsiboost  -C  -W 3 -N ngram  -S agent < agent.test
