...
var ThresholdClassifier = function ThresholdClassifier(opts) {
  ...
  this.multiclassClassifier = new opts.multiclassClassifierType(); // [F1, Accuracy]	

  this.evaluateMeasureToMaximize = opts.evaluateMeasureToMaximize; // constant size of validation set

  this.devsetsize = 0.1; // > 1, n - fold cross - validation, otherwise validation set
