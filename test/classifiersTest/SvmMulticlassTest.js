...
import { EnhancedClassifier, SvmLinear } from "../../dist/core";
...
if (!SvmLinear.isInstalled()) {
  ...
  var SvmClassifier = SvmLinear.bind(0, {
    multiclass: true,
    learn_args: "-c 20.0"
  });

  describe(
    "SVM-LibLinear multiclass" + " with numeric features and numeric labels",
    function() {
      var trainSet = [
        {
          input: [0, 0],
  ...
  var SvmClassifierStringLabels = EnhancedClassifier.bind(this, {
    classifierType: SvmClassifier,
    labelLookupTable: new FeatureLookupTable()
  });

  describe(
    "SVM-LibLinear multiclass" + " with numeric features and string labels",
    function() {
      var trainSet = [
        {
          input: [0, 0],
