import { classifiers, features as _features } from "../../index";

// First, define our base classifier type (a multi-label classifier based on winnow):
var TextClassifier = classifiers.multilabel.BinaryRelevance.bind(0, {
...
describe("winnow classifier", function() {
  it("works with a feature-extractor", function() {
    ...
    var intentClassifier = new classifiers.EnhancedClassifier({
    ...
    intentClassifier
      .classify("I want an apple and a banana")
      .sort()
      .should.eql(["apl", "bnn"]);
    intentClassifier
      .classify("I WANT AN APPLE AND A BANANA")
      .sort()
      .should.eql([]); // case sensitive
  });
});
...
describe("winnow classifier", function() {
  it("works with a case-normalizer", function() {
    ...
    intentClassifier = new classifiers.EnhancedClassifier({
      classifierType: TextClassifier,
      normalizer: _features.LowerCaseNormalizer,
      featureExtractor: WordExtractor
    });
    ...
    intentClassifier
      .classify("I WANT AN APPLE AND A BANANA")
      .sort()
      .should.eql(["apl", "bnn"]); // case insensitive
  });
});
