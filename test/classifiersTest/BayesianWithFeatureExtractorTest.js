import { Bayesian, EnhancedClassifier } from "../../dist/core";
...
describe("bayesian classifier with a single feature extractor for words", function() {
  ...
  it("explains its decisions", function() {
    ...
    c = spamClassifier.classify(
      "I don't know if this is a replica of windows",
      1
    );
  ...
  it.skip("supports continuous output", function() {
    spamClassifier
      .classify("I don't know if this is a replica of windows", 0, true)
      .should.be.above(0);
