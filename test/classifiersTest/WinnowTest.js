...
var WinnowClassifier = Winnow.bind(this, {
	retrain_count: 10,
	do_averaging: false,
	margin: 1,
});
...
describe('winnow classifier', function () {
	...
	it('explains its decisions', function () {
		...
		classifier.classify({
			'a': 0,
			'b': 0
		}, /*explain=*/ 1).should.have.property('explanation').with.lengthOf(1);
		classifier.classify({
			'a': 0,
			'b': 0
		}, /*explain=*/ 3).should.have.property('explanation').with.lengthOf(3);
	})
})