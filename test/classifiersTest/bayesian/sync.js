...
function testBasic(createNewClassifierFunction) {
  ...
  equal(bayes.classify(wordcounts("replica watches")), "spam");
  equal(bayes.classify(wordcounts("check out the docs")), "notspam");
  equal(
    bayes.classify(wordcounts("recently, I've been thinking that I should")),
    "notspam"
  );
  equal(
    bayes.classify(wordcounts("come buy these cheap pills")),
    "spam"
  );
  ...
  equal(bayes2.classify(wordcounts("replica watches")), "spam");
  equal(bayes2.classify(wordcounts("check out the docs")), "notspam");
  equal(
    bayes2.classify(wordcounts("recently, I've been thinking that I should")),
    "notspam"
  );
  equal(
    bayes2.classify(wordcounts("come buy these cheap pills")),
    "spam"
  );
}
