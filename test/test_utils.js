...
*/
import PrecisionRecall from '../dist/utils/PrecisionRecall';

export function test(dataset, classifier) {
...
export function F1_evaluation(stats, type_of_averaging) {
	if (type_of_averaging == 0) {
		if ((stats['TP'] == 0) || (stats['TP'] + stats['FP'] == 0) || (stats['TP'] + stats['FN'] == 0))
			return 0;
